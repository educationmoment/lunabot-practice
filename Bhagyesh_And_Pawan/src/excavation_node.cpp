...
/**
 * @param health_msg interfaces_pkg::msg::MotorHealth, tilt_position read from node and stored in buffers
 * @returns None
 */
...
void Excavate(const std::shared_ptr<interfaces_pkg::srv::ExcavationRequest::Request> request,
    std::shared_ptr<interfaces_pkg::srv::ExcavationRequest::Response> response) {
        ...
        MoveBucket(-2.5, -2.6 + buffer, false, 0.0f); // MoveBucket (float lift_setpoint, float tilt_setpoint, bool activate_vibrator, float drive_speed)
